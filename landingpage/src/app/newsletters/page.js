                ...
                {[
                  {
                    ...
                    description: "Get insights into our business developments and partnerships"
                  },
                  {
                    icon: "🎯",
                    title: "Industry Insights",
                    description: "Learn about trends in AI education and our thought leadership"
                  },
                  {
                    icon: "🤝",
                    title: "Community Engagement",
                    description: "Connect with our team and join the conversation"
                  }
                ].map((feature, index) => (
                  <motion.div
                    key={feature.title}
                    ...
                    className="bg-white/70 backdrop-blur-sm p-6 rounded-xl border border-white/20 text-center shadow-sm"
                  >
